 ...
 * Notes: This file is ment to pull the IPs, gamertags, and realm codes of the people that use .
...
export const updateLang = () => Object.assign(Lang, {
    setup: {
        version: '§6 Version: §eV3 part 2, Light!§6, Min Engine: §e1.19.40§6\nAPI: §3 Light§6,\nBETA: §eYES§6, J: §eNO§e\nCoded and Designed By Mo9ses, Copyright 2023 all rights reserved.§r',
        loaded: (ms) => ` has been loaded in §6${ms}§e milliseconds!§r`,
    },
    cmd: {
    ...
    chat: {
        mutted: 'Sorry, you have been muted by  or an admin',
    }
});
